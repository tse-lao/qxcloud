        ...
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? 'hover:bg-white/10' : 'hover:bg-sky-950/10'
            )}
          ...
          >
            <Icon
              className={clsx(
                'h-6 w-6',
                invert
                  ? 'fill-white group-hover:fill-sky-200'
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full fill-sky-50 stroke-sky-950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
            yOffset={-96}
            interactive
          />
